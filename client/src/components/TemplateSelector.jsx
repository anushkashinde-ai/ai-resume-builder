...
const TemplateSelector = ({ selectedTemplate, onChange }) => {
  ...
  const templates = [
    ...
    },
    {
      id: "modern",
      name: "Modern",
      preview: "Sleek design with bold headings and contemporary layout",
    },
    {
      id: "minimal-image",
      name: "Minimal Image",
      preview: "A minimalist design with a clean layout and image integration.",
    },
    {
      id: "minimal",
      name: "Minimal",
      preview:
        "A simple, uncluttered design focusing on content with ample white space.",
    },
  ];
  return (
