...
const Testimonial = () => {
  ...
  return (
    ...
    <div id='testimonials' className='flex flex-col items-center my-10 scroll-mt-12'>
        ...
        <Title title="Don`t just take our words " description="Hera what our users say. We`re always looking for ways to improve. If you have a positive experience with us, keave a review." />
    </div>
